...
| F | Интервал ТО (дней) | Периодичность обслуживания |
| G | Напоминание (за дней) | За сколько дней предупреждать |
| H | Дата последнего ТО | Когда проводилось ТО |
| I | Дата следующего ТО | Автоматически рассчитывается |
| J | Статус | Автоматически определяется |
