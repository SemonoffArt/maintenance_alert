...
- 🚨 **СРОЧНО** - требуется немедленное обслуживание (просрочено)
- ⚠️ **Внимание** - приближается срок обслуживания (в пределах напоминания)
- ✅ **В норме** - оборудование обслужено вовремя
...
| F | Выполнить | Действия для выполнения |
...
### Зависимости
```
pandas >= 2.3.1       # Работа с данными
openpyxl >= 3.1.5     # Чтение Excel файлов
matplotlib >= 3.10.5  # Создание графиков
